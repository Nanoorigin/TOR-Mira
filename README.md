...
<p align="center"><a href="https://github.com/Nanoorigin/TOR-Mira/releases/"><img src="https://badgen.net/github/release/Nanoorigin/TOR-Mira"></a></p>
...
该 **The Other Roles Mira** is a mod for [Among Us](https://store.steampowered.com/app/945360/Among_Us) which adds many new roles, new [Settings](#settings) and new [Custom Hats](#custom-hats) to the game.
...
1. Download the newest [release](https://github.com/Nanoorigin/TOR-Mira/releases/latest)
...
2. Download newest [release](https://github.com/Nanoorigin/TOR-Mira/releases/latest) and extract it to ~/.steam/steam/steamapps/common/Among Us
...
(Currently only the 'nightly' tag is starting a server supporting 17.0.0 or later)
...
# Credits & Resources
Team:
Nanoorigin    FangkuaiYa    Farewell

Github Contributors:
无

[Discord](https://discord.gg/TUceswKfRg]Discord)
