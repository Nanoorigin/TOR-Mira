        ...
        public class GameStartManagerUpdatePatch {
            ...
            public static void Postfix(GameStartManager __instance) {
                ...
                // Client update with handshake infos
                    ...
                    if (!__instance.GameStartText.text.StartsWith("Starting") || !OptionGroupSingleton<GameplaySettings>.Instance.AnyPlayerCanStopStart)
                        copiedStartButton?.Destroy();
                    if (OptionGroupSingleton<GameplaySettings>.Instance.AnyPlayerCanStopStart && copiedStartButton == null && __instance.GameStartText.text.StartsWith("Starting")) {
        ...
        public class GameStartManagerBeginGame {
            public static bool Prefix(GameStartManager __instance) {
                ...
                if (AmongUsClient.Instance.AmHost) {
                    ...
                    if (continueStart && (TORMapOptions.GameMode == CustomGamemodes.HideNSeek || TORMapOptions.GameMode == CustomGamemodes.PropHunt) && GameOptionsManager.Instance.CurrentGameOptions.MapId != 6) {
                    ...
                    else if (OptionGroupSingleton<RandomMaps>.Instance.DynamicMap && continueStart) {
                        // 0 = Skeld
                        // 1 = Mira HQ
                        // 2 = Polus
                        // 3 = Dleks - deactivated
                        ...
                        [
                            OptionGroupSingleton<RandomMaps>.Instance.DynamicMapEnableSkeld.Value / 100f,
                            OptionGroupSingleton<RandomMaps>.Instance.DynamicMapEnableMira.Value / 100f,
                            OptionGroupSingleton<RandomMaps>.Instance.DynamicMapEnablePolus.Value / 100f,
                            OptionGroupSingleton<RandomMaps>.Instance.DynamicMapEnableAirship.Value / 100f,
                            OptionGroupSingleton<RandomMaps>.Instance.DynamicMapEnableFungle.Value / 100f,
                            OptionGroupSingleton<RandomMaps>.Instance.DynamicMapEnableSubmerged.Value / 100f,
                        ];
