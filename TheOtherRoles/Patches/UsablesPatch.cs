...
namespace TheOtherRoles.Patches {
    ...
    public static class ConsoleCanUsePatch {
        public static bool Prefix(ref float __result, Console __instance, [HarmonyArgument(0)] NetworkedPlayerInfo pc, [HarmonyArgument(1)] out bool canUse, [HarmonyArgument(2)] out bool couldUse) {
            ...
            if (!TORHelpers.hasFakeTasks(pc.Object)) return true;
            __result = float.MaxValue;
            return false;
        }
    }
                                ...
                                if (collider2D.CompareTag("DeadBody") && __instance.includeDeadBodies) {
                                    ...
                                    if (bodyComponent) {
                                        ...
                                        if (playerInfo != null) {
                                            ...
                                            if (Hacker.onlyColorType)
                                                color = TORHelpers.isD(playerInfo.PlayerId) ? Palette.PlayerColors[7] : Palette.PlayerColors[6];
                                    ...
                                    if (component && component.Data != null && !component.Data.Disconnected && !component.Data.IsDead && (__instance.showLivePlayerPosition || !component.AmOwner) && hashSet.Add((int)component.PlayerId)) {
                                        ...
                                        if (component?.cosmetics?.currentBodySprite?.BodySprite?.material != null) {
                                            ...
                                            if (Hacker.onlyColorType) {
                                                color = TORHelpers.isLighterColor(component) ? Palette.PlayerColors[7] : Palette.PlayerColors[6];
                                            }
                                            roomColors.Add(color);
                                        }
                                    }
    ...
    class SurveillanceMinigamePatch {
        ...
        private static Sprite overlaySprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.NightVisionOverlay.png", 350f);
        ...
        private static void nightVisionUpdate(SurveillanceMinigame SkeldCamsMinigame = null, PlanetSurveillanceMinigame SwitchCamsMinigame = null, FungleSurveillanceMinigame FungleCamMinigame = null) {
            ...
            bool ignoreNightVision = OptionGroupSingleton<NightVisionCams>.Instance.CamsNoNightVisionIfImpVision && TORHelpers.hasImpVision(GameData.Instance.GetPlayerById(PlayerControl.LocalPlayer.PlayerId)) || PlayerControl.LocalPlayer.Data.IsDead;
            bool nightVisionEnabled = OptionGroupSingleton<NightVisionCams>.Instance.CamsNightVision;
            ...
            if (nightVisionIsActive) {
                ...
                foreach (PlayerControl pc in PlayerControl.AllPlayerControls) {
                    if (Camouflager.camouflageTimer > 0) {
                        ...
                        TORHelpers.setDefaultLook(pc, false);
                    }
                    // Dead Bodies
                    foreach (DeadBody deadBody in GameObject.FindObjectsOfType<DeadBody>()) {
    ...
    class ShowSabotageMapPatch {
        static bool Prefix(MapBehaviour __instance) {
            ...
            if (PlayerControl.LocalPlayer.Data.IsDead && OptionGroupSingleton<GameplaySettings>.Instance.DeadImpsBlockSabotage) {
