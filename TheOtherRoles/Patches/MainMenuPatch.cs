...
namespace TheOtherRoles.Modules {
    ...
    public class MainMenuPatch {
        ...
        private static void Prefix(MainMenuManager __instance) {
            ...
            passiveButtonDiscord.OnClick.AddListener((System.Action)(() => Application.OpenURL("https://discord.gg/TUceswKfRg")));
        ...
        public static void addSceneChangeCallbacks() {
            SceneManager.add_sceneLoaded((Action<Scene, LoadSceneMode>)((scene, _) => {
                ...
                template.StartCoroutine(Effects.Lerp(0.1f, new System.Action<float>((p) => {
                    guesserButtonText.SetText("TORMira Guesser");
                    HideNSeekButtonText.SetText("TORMira Hide N Seek");
                    PropHuntButtonText.SetText("TORMira Prop Hunt");
                })));
            }));
        }
    }
