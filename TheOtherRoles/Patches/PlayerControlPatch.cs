...
namespace TheOtherRoles.Patches {
    ...
    public static class PlayerControlFixedUpdatePatch {
        ...
        static void setBasePlayerOutlines() {
            foreach (PlayerControl target in PlayerControl.AllPlayerControls) {
                ...
                if (Camouflager.camouflageTimer <= 0f && !TORHelpers.MushroomSabotageActive() && Medic.shieldVisible(target))
                    hasVisibleShield = true;

                if (Camouflager.camouflageTimer <= 0f && !TORHelpers.MushroomSabotageActive() && TORMapOptions.firstKillPlayer != null && TORMapOptions.shieldFirstKill && ((target == TORMapOptions.firstKillPlayer && !isMorphedMorphling) || (isMorphedMorphling && Morphling.morphTarget == TORMapOptions.firstKillPlayer))) {
                    hasVisibleShield = true;
                    color = Color.blue;
                }
        ...
        public static void playerSizeUpdate(PlayerControl p) {
            ...
            if (Mini.mini == null || Camouflager.camouflageTimer > 0f || TORHelpers.MushroomSabotageActive() || Mini.mini == Morphling.morphling && Morphling.morphTimer > 0) return;
            ...
            foreach (PlayerControl p in PlayerControl.AllPlayerControls) {
                ...
                if ((Lawyer.lawyerKnowsRole && PlayerControl.LocalPlayer == Lawyer.lawyer && p == Lawyer.target) || p == PlayerControl.LocalPlayer || PlayerControl.LocalPlayer.Data.IsDead) {
                    ...
                    if (p == PlayerControl.LocalPlayer) {
                        ...
                        if (p == Swapper.swapper) playerInfoText = $"{roleNames}" + TORHelpers.cs(Swapper.color, $" ({Swapper.charges})");
        ...
        static void snitchUpdate() {
            ...
            if (Snitch.isRevealed && ((Snitch.targets == Snitch.Targets.EvilPlayers && TORHelpers.isEvil(local)) || (Snitch.targets == Snitch.Targets.Killers && TORHelpers.isKiller(local)))) {
                if (Snitch.text == null) {
        ...
        static void morphlingAndCamouflagerUpdate() {
            bool mushRoomSaboIsActive = TORHelpers.MushroomSabotageActive();
        ...
        static void bloodyUpdate() {
            ...
            foreach (KeyValuePair<byte, float> entry in new Dictionary<byte, float>(Bloody.active)) {
                PlayerControl player = TORHelpers.PlayerById(entry.Key);
                PlayerControl bloodyPlayer = TORHelpers.PlayerById(Bloody.bloodyKillerMap[player.PlayerId]);      
        ...
        public static void Postfix(PlayerControl __instance) {
            ...
            if (PlayerControl.LocalPlayer == __instance) {
                ...
                TORHelpers.refreshRoleDescription(__instance);
    ...
    class PlayerPhysicsWalkPlayerToPatch {
        ...
        public static void Prefix(PlayerPhysics __instance) {
            bool correctOffset = Camouflager.camouflageTimer <= 0f && !TORHelpers.MushroomSabotageActive() && (__instance.myPlayer == Mini.mini ||  (Morphling.morphling != null && __instance.myPlayer == Morphling.morphling && Morphling.morphTarget == Mini.mini && Morphling.morphTimer > 0f));
    ...
    class PlayerControlCmdReportDeadBodyPatch {
        public static bool Prefix(PlayerControl __instance) {
            ...
            TORHelpers.handleVampireBiteOnBodyReport();
            return true;
        }
    }
                ...
                if (deadPlayer != null && deadPlayer.killerIfExisting != null) {
                    ...
                    if (isMedicReport) {
                        ...
                        if (timeSinceDeath < Detective.reportNameDuration * 1000) {
                            ...
                            var typeOfColor = TORHelpers.isLighterColor(deadPlayer.killerIfExisting) ? "lighter" : "darker";
    ...
    public static class MurderPlayerPatch
    {
        ...
        public static void Postfix(PlayerControl __instance, [HarmonyArgument(0)]PlayerControl target)
        {
            ...
            if (Seer.seer != null && (PlayerControl.LocalPlayer == Seer.seer || TORHelpers.shouldShowGhostInfo()) && !Seer.seer.Data.IsDead && Seer.seer != target && Seer.mode <= 1) {
                TORHelpers.showFlash(new Color(42f / 255f, 187f / 255f, 245f / 255f), message : "Seer Info: Someone Died");
            }
            ...
            if (Bait.bait.FindAll(x => x.PlayerId == target.PlayerId).Count > 0) {
                ...
                if (Bait.showKillFlash && __instance == PlayerControl.LocalPlayer) TORHelpers.showFlash(new Color(204f / 255f, 102f / 255f, 0f / 255f));
            }
            ...
            if (Vip.vip.FindAll(x => x.PlayerId == target.PlayerId).Count > 0) {
                ...
                TORHelpers.showFlash(color, 1.5f);
            }
