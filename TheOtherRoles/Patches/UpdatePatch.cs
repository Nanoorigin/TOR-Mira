    ...
    class HudManagerUpdatePatch
    {
        ...
        static void resetNameTagsAndColors() {
            ...
            foreach (var data in GameData.Instance.AllPlayers.GetFastEnumerator())
            {
                ...
                if (player)
                {
                    ...
                    nameText.text = TORHelpers.hidePlayerName(localPlayer, player) ? "" : playerName;
        ...
        static void setNameTags() {
            ...
            if (Lovers.lover1 != null && Lovers.lover2 != null && (Lovers.lover1 == PlayerControl.LocalPlayer || Lovers.lover2 == PlayerControl.LocalPlayer)) {
                string suffix = TORHelpers.cs(Lovers.color, " ♥");
            ...
            if ((Lawyer.lawyer != null && Lawyer.target != null && Lawyer.lawyer == PlayerControl.LocalPlayer)) {
                ...
                string suffix = TORHelpers.cs(color, " §");
            ...
            if (Thief.formerThief != null && (Thief.formerThief == PlayerControl.LocalPlayer || PlayerControl.LocalPlayer.Data.IsDead)) {
                string suffix = TORHelpers.cs(Thief.color, " $");
            ...
            if (PlayerControl.LocalPlayer != null && MeetingHud.Instance != null && TORMapOptions.showLighterDarker) {
                foreach (PlayerVoteArea player in MeetingHud.Instance.playerStates) {
                    var target = TORHelpers.PlayerById(player.TargetPlayerId);
                    if (target != null)  player.NameText.text += $" ({(TORHelpers.isLighterColor(target) ? "L" : "D")})";
                }
            }
            ...
            if (MeetingHud.Instance != null && Medic.medic != null && Medic.shielded != null && Medic.shieldVisible(Medic.shielded)) {
                foreach (PlayerVoteArea player in MeetingHud.Instance.playerStates)
                    if (player.TargetPlayerId == Medic.shielded.PlayerId) {
                        player.NameText.text = TORHelpers.cs(Medic.color, "[") + player.NameText.text + TORHelpers.cs(Medic.color, "]");
        ...
        public static void miniUpdate() {
            if (Mini.mini == null || Camouflager.camouflageTimer > 0f || TORHelpers.MushroomSabotageActive() || Mini.mini == Morphling.morphling && Morphling.morphTimer > 0f || Mini.mini == Ninja.ninja && Ninja.isInvisble || SurveillanceMinigamePatch.nightVisionIsActive) return;
        ...
        static void updateSabotageButton(HudManager __instance) {
            ...
            if (PlayerControl.LocalPlayer.Data.IsDead && OptionGroupSingleton<GameplaySettings>.Instance.DeadImpsBlockSabotage) __instance.SabotageButton.Hide();
        }
