    ...
    class RoleDraft
    {
            ...
            while (pickOrder.Count > 0) {
                ...
                while (timer < maxTimer || !picked) {
                    ...
                    if (PlayerControl.LocalPlayer.PlayerId == pickOrder[0]) {
                        ...
                        playerText = TORHelpers.cs(youColor, "You!");
                        // Available Roles:
                        ...
                        foreach (RoleInfo roleInfo in RoleInfo.allRoleInfos) {
                            ...
                            if (PlayerControl.LocalPlayer.Data.Role.IsImpostor) {
                                ...
                                int impsLeft = pickOrder.Where(x => TORHelpers.PlayerById(x).Data.Role.IsImpostor).Count();
                            ...
                            // Player is no impostor! Handle forcing of 100% roles for crew and neutral
                                ...
                                var crewmatesLeft = pickOrder.Count - pickOrder.Where(x => TORHelpers.PlayerById(x).Data.Role.IsImpostor).Count();
                    ...
                    __instance.TeamTitle.text = $"{TORHelpers.cs(Color.white, "<size=280%>Welcome to the Role Draft!</size>")}\n\n\n<size=200%> Currently Picking:</size>\n\n\n<size=250%>{playerText}</size>";
        ...
        public static void receivePick(byte playerId, byte roleId)
        {
            ...
            try
            {
                ...
                string roleString = TORHelpers.cs(roleInfo.color, roleInfo.name);
                ...
                if (!CustomOptionHolder.draftModeShowRoles.getBool() && !(playerId == PlayerControl.LocalPlayer.PlayerId)) {
                    ...
                    roleString = TORHelpers.cs(Palette.ImpostorRed, "Impostor Role");
                    ...
                    roleString = TORHelpers.cs(Palette.Blue, "Neutral Role");
