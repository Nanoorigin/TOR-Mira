    ...
    class GameModePatches {
        ...
        class LobbyInfoPanePatch {
            ...
            public static void Postfix(LobbyInfoPane __instance) {
                ...
                __instance.StartCoroutine(Effects.Lerp(0.1f, new Action<float>(p => { pButton.buttonText.text = TORHelpers.cs(Color.yellow, GameModeText.GetComponent<TextMeshPro>().text); })));
