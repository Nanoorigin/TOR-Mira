...
namespace TheOtherRoles.CustomGameModes {
    ...
    class PropHunt {
        ...
        public static void clearAndReload() {
            ...
            numberOfHunters = (int)OptionGroupSingleton<HunterSettings>.Instance.PropHuntNumberOfHunters;
            initialBlackoutTime = OptionGroupSingleton<HunterSettings>.Instance.HunterInitialBlackoutTime;
            //maxMissesBeforeDeath = CustomOptionHolder.hunterMaxMissesBeforeDeath.getQuantity();
            propBecomesHunterWhenFound = OptionGroupSingleton<PropSettings>.Instance.PropBecomesHunterWhenFound;
            killCooldownMiss = OptionGroupSingleton<HunterSettings>.Instance.HunterMissCooldown;
            killCooldownHit = OptionGroupSingleton<HunterSettings>.Instance.HunterHitCooldown;
            hunterVision = OptionGroupSingleton<GeneralProppHuntSettings>.Instance.PropHunterVision;
            propVision = OptionGroupSingleton<GeneralProppHuntSettings>.Instance.PropVision;
            timer = OptionGroupSingleton<GeneralProppHuntSettings>.Instance.PropHuntTimer * 60;
            revealDuration = OptionGroupSingleton<HunterSettings>.Instance.PropHuntRevealDuration;
            revealCooldown = OptionGroupSingleton<HunterSettings>.Instance.PropHuntRevealCooldown;
            unstuckDuration = OptionGroupSingleton<GeneralProppHuntSettings>.Instance.PropHuntUnstuckDuration;
            unstuckCooldown = OptionGroupSingleton<GeneralProppHuntSettings>.Instance.PropHuntUnstuckCooldown;
            revealPunish = OptionGroupSingleton<HunterSettings>.Instance.PropHuntRevealPunish;
            invisCooldown = OptionGroupSingleton<PropSettings>.Instance.PropHuntInvisCooldown.Value;
            invisDuration = OptionGroupSingleton<PropSettings>.Instance.PropHuntInvisDuration.Value;
            speedboostCooldown = OptionGroupSingleton<PropSettings>.Instance.PropHuntSpeedboostCooldown.Value;
            speedboostDuration = OptionGroupSingleton<PropSettings>.Instance.PropHuntSpeedboostDuration.Value;
            speedboostRatio = OptionGroupSingleton<PropSettings>.Instance.PropHuntSpeedboostSpeed.Value;
            enableSpeedboost = OptionGroupSingleton<PropSettings>.Instance.PropHuntSpeedboostEnabled;
            enableInvis = OptionGroupSingleton<PropSettings>.Instance.PropHuntInvisEnabled;
            adminCooldown = OptionGroupSingleton<HunterSettings>.Instance.PropHuntAdminCooldown;
            findCooldown = OptionGroupSingleton<HunterSettings>.Instance.PropHuntFindCooldown;
            findDuration = OptionGroupSingleton<HunterSettings>.Instance.PropHuntFindDuration;
            timerRunning = false;
            timerText?.Destroy();
            timerText = null;
            currentObject = new();
        ...
        public static Sprite getIntroSprite(int index) {
            return TORHelpers.loadSpriteFromResources($"TheOtherRoles.Resources.IntroAnimation.intro_{index + 1000}.png", 150f, cache: false);
        }

        public static void updateWhitelistedObjects(bool debug=false) {
            string allNames = TORHelpers.readTextFromResources("TheOtherRoles.Resources.Txt.Props.txt");
            if (debug) {
                allNames = TORHelpers.readTextFromFile(System.IO.Directory.GetCurrentDirectory() + "\\Props.txt");
            }
        ...
        public static void propTargetAndTimerDisplayUpdate() {
            ...
            if (timerText == null) {
                ...
                if (timerRunning || blackOutTimer > 0f) {
                    ...
                    timerText.text = TORHelpers.cs(timerRunning ? Color.blue : Color.red, suffix);
        ...
        public static void poolablePlayerUpdate() {
            if (poolablesBackground == null) {
                ...
                if (poolablesBackgroundSprite == null) poolablesBackgroundSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.poolablesBackground.jpg", 200f);
            }
            ...
            foreach (var pc in PlayerControl.AllPlayerControls) {
                ...
                if (pc.Data.IsDead) {
                    ...
                    poolablePlayer.cosmetics.nameText.text = TORHelpers.cs(Palette.DisabledGrey, pc.Data.PlayerName); ;
                } else if (pc.Data.Role.IsImpostor) {
                    poolablePlayer.cosmetics.nameText.text = TORHelpers.cs(Palette.ImpostorRed, pc.Data.PlayerName);
                    ...
                    // Display Prop
                    poolablePlayer.cosmetics.nameText.text = TORHelpers.cs(Palette.CrewmateBlue, pc.Data.PlayerName);
                }
        ...
        public static void invisUpdate() {
            foreach (var playerId in invisPlayers.Keys) {
                var pc = TORHelpers.PlayerById(playerId);
        ...
        public static Sprite getDisguiseButtonSprite() {
            ...
            disguiseButtonSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.DisguiseButton.png", 115f);
            return disguiseButtonSprite;
        }

        public static Sprite getUnstuckButtonSprite() {
            if (unstuckButtonSprite) return unstuckButtonSprite;
            unstuckButtonSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.UnStuck.png", 115f);
            return unstuckButtonSprite;
        }
        public static Sprite getRevealButtonSprite() {
            if (revealButtonSprite) return revealButtonSprite;
            revealButtonSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.Reveal.png", 115f);
            return revealButtonSprite;
        }

        public static Sprite getInvisButtonSprite() {
            if (invisButtonSprite) return invisButtonSprite;
            invisButtonSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.InvisButton.png", 115f);
            return invisButtonSprite;
        }

        public static Sprite getFindButtonSprite() {
            if (findButtonSprite) return findButtonSprite;
            findButtonSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.FindButton.png", 115f);
        ...
        public static Sprite getSpeedboostButtonSprite() {
            ...
            speedboostButtonSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.SpeedboostButton.png", 115f);
        ...
        public static bool KillButtonClickPatch(KillButton __instance) {
            ...
            if (__instance.currentTarget == null) {
                ...
                MurderAttemptResult res = TORHelpers.checkMurderAttemptAndKill(PlayerControl.LocalPlayer, __instance.currentTarget);
