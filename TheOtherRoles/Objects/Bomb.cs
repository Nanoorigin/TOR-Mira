...
namespace TheOtherRoles.Objects {
    public class Bomb {
        ...
        public static Sprite getBombSprite() {
            ...
            bombSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.Bomb.png", 300f);
            return bombSprite;
        }
        public static Sprite getBackgroundSprite() {
            if (backgroundSprite) return backgroundSprite;
            backgroundSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.BombBackground.png", 110f / Bomber.hearRange);
            return backgroundSprite;
        }

        public static Sprite getDefuseSprite() {
            if (defuseSprite) return defuseSprite;
            defuseSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.Bomb_Button_Defuse.png", 115f);
            return defuseSprite;
        }
        ...
        public static void explode(Bomb b) {
            ...
            if (Bomber.bomber != null) {
                ...
                if (distance < Bomber.destructionRange && !PlayerControl.LocalPlayer.Data.IsDead) {
                    TORHelpers.checkMurderAttemptAndKill(Bomber.bomber, PlayerControl.LocalPlayer, false, false, true, true);
