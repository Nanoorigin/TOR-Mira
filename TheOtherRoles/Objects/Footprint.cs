...
namespace TheOtherRoles.Objects 
{
    public class FootprintHolder : MonoBehaviour {
        ...
        private static Sprite FootprintSprite => _footprintSprite ??= TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.Footprint.png", 600f);
        ...
        private void FootprintUpdate() {
            ...
            foreach (var activeFootprint in _activeFootprints) {
                ...
                Color color;
                if (AnonymousFootprints || Camouflager.camouflageTimer > 0 || TORHelpers.MushroomSabotageActive()) {
