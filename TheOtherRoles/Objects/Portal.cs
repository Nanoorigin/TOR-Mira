    ...
    public class Portal {
        ...
        public static Sprite getFgAnimationSprite(int index) {
            ...
            if (portalFgAnimationSprites[index] == null)
                portalFgAnimationSprites[index] = (TORHelpers.loadSpriteFromResources($"TheOtherRoles.Resources.PortalAnimation.portal_{(index):000}.png", 115f));
        ...
        public static void startTeleport(byte playerId, byte exit) {
            ...
            // Generate log info
            PlayerControl playerControl = TORHelpers.PlayerById(playerId);
            ...
            string playerNameDisplay = Portalmaker.logOnlyHasColors ? "A player (" + (TORHelpers.isLighterColor(playerControl) ? "L" : "D") + ")" : playerControl.Data.PlayerName;

            int colorId = playerControl.Data.DefaultOutfit.ColorId;

            if (Camouflager.camouflageTimer > 0 || TORHelpers.MushroomSabotageActive()) {
        ...
        private static void preloadSprites() {
            ...
            portalSprite = TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.PortalAnimation.plattform.png", 115f);
        }
