...
namespace TheOtherRoles.Objects {
    class Bloodytrail {
        ...
        public static List<Sprite> getBloodySprites() {
            ...
            sprites.Add(TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.Blood1.png", 700));
            sprites.Add(TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.Blood2.png", 500));
            sprites.Add(TORHelpers.loadSpriteFromResources("TheOtherRoles.Resources.Blood3.png", 300));
            return sprites;
        }
        ...
        public Bloodytrail(PlayerControl player, PlayerControl bloodyPlayer) {
            ...
            Color c = color;
            if (Camouflager.camouflageTimer > 0 || TORHelpers.MushroomSabotageActive()) c = Palette.PlayerColors[6];
