...
namespace TheOtherRoles
{
    ...
    public static class RPCProcedure {
        ...
        public static void resetVariables() {
            ...
            reloadPluginOptions();
            TORHelpers.toggleZoom(reset : true);
    ...
    public static void HandleShareOptions(byte numberOfOptions, MessageReader reader) {            
        ...
        public static void stopStart(byte playerId) {
            if (!OptionGroupSingleton<GameplaySettings>.Instance.AnyPlayerCanStopStart)
                return;
            SoundManager.Instance.StopSound(GameStartManager.Instance.gameStartSound);
            Helpers.CreateAndShowNotification($"{TORHelpers.PlayerById(playerId).Data.PlayerName} stopped the game start!", Color.white, HudManager.Instance.Notifier.settingsChangeSound);
        ...
        public static void setRole(byte roleId, byte playerId) {
            foreach (PlayerControl player in PlayerControl.AllPlayerControls) {
                if (player.PlayerId == playerId) {
                    ...
                    if (AmongUsClient.Instance.AmHost && TORHelpers.roleCanUseVents(player) && !player.Data.Role.IsImpostor) {
        ...
        public static void setModifier(byte modifierId, byte playerId, byte flag) {
            PlayerControl player = TORHelpers.PlayerById(playerId); 
        ...
        public static void uncheckedMurderPlayer(byte sourceId, byte targetId, byte showAnimation) {
            if (AmongUsClient.Instance.GameState != InnerNet.InnerNetClient.GameStates.Started) return;
            PlayerControl source = TORHelpers.PlayerById(sourceId);
            PlayerControl target = TORHelpers.PlayerById(targetId);
        ...
        public static void uncheckedCmdReportDeadBody(byte sourceId, byte targetId) {
            PlayerControl source = TORHelpers.PlayerById(sourceId);
            var t = targetId == Byte.MaxValue ? null : TORHelpers.PlayerById(targetId).Data;
        ...
        public static void engineerUsedRepair() {
            ...
            if (TORHelpers.shouldShowGhostInfo()) {
                TORHelpers.showFlash(Engineer.color, 0.5f, "Engineer Fix"); ;
            }
        }
        ...
        public static void medicSetShielded(byte shieldedId) {
            ...
            Medic.shielded = TORHelpers.PlayerById(shieldedId);
        ...
        public static void shieldedMurderAttempt() {
            ...
            if (isShieldedAndShow || isMedicAndShow || TORHelpers.shouldShowGhostInfo()) TORHelpers.showFlash(Palette.ImpostorRed, duration: 0.5f, "Failed Murder Attempt on Shielded Player");
        }

        public static void shifterShift(byte targetId) {
            PlayerControl oldShifter = Shifter.shifter;
            PlayerControl player = TORHelpers.PlayerById(targetId);
            ...
            if ((player.Data.Role.IsImpostor || TORHelpers.isNeutral(player)) && !oldShifter.Data.IsDead) {
                oldShifter.Exiled();
        ...
        public static void morphlingMorph(byte playerId) {  
            PlayerControl target = TORHelpers.PlayerById(playerId);
        ...
        public static void camouflagerCamouflage() {
            ...
            if (TORHelpers.MushroomSabotageActive()) return; // Dont overwrite the fungle "camo"
            foreach (PlayerControl player in PlayerControl.AllPlayerControls)
                player.setLook("", 6, "", "", "", "");
        ...
        public static void setFutureShifted(byte playerId) {
            Shifter.futureShift = TORHelpers.PlayerById(playerId);
        }

        public static void setFutureShielded(byte playerId) {
            Medic.futureShielded = TORHelpers.PlayerById(playerId);
            Medic.usedShield = true;
        }
        ...
        public static void setInvisible(byte playerId, byte flag)
        {
            ...
            if (flag == byte.MaxValue)
            {
                ...
                if (Camouflager.camouflageTimer <= 0 && !TORHelpers.MushroomSabotageActive()) target.setDefaultLook();
        ...
        public static void lightsOut() {
            ...
            if(TORHelpers.hasImpVision(GameData.Instance.GetPlayerById(PlayerControl.LocalPlayer.PlayerId))) {
        ...
        public static void lawyerSetTarget(byte playerId) {
            Lawyer.target = TORHelpers.PlayerById(playerId);
        }
        ...
        public static void guesserShoot(byte killerId, byte dyingTargetId, byte guessedTargetId, byte guessedRoleId) {
            PlayerControl dyingTarget = TORHelpers.PlayerById(dyingTargetId);
            ...
            PlayerControl guesser = TORHelpers.PlayerById(killerId);
            ...
            if (MeetingHud.Instance) {
                foreach (PlayerVoteArea pva in MeetingHud.Instance.playerStates) {
                    ...
                    pva.UnsetVote();
                    var voteAreaPlayer = TORHelpers.PlayerById(pva.TargetPlayerId);
            ...
            PlayerControl guessedTarget = TORHelpers.PlayerById(guessedTargetId);
        ...
        public static void receiveGhostInfo (byte senderId, MessageReader reader) {
            PlayerControl sender = TORHelpers.PlayerById(senderId);
            ...
            switch (infoType) {
                ...
                case GhostInfoTypes.ArsonistDouse:
                    Arsonist.dousedPlayers.Add(TORHelpers.PlayerById(reader.ReadByte()));
                    break;
                case GhostInfoTypes.BountyTarget:
                    BountyHunter.bounty = TORHelpers.PlayerById(reader.ReadByte());
                    break;
                case GhostInfoTypes.NinjaMarked:
                    Ninja.ninjaMarked = TORHelpers.PlayerById(reader.ReadByte());
                    break;
                case GhostInfoTypes.WarlockTarget:
                    Warlock.curseVictim = TORHelpers.PlayerById(reader.ReadByte());
                    break;
                ...
                case GhostInfoTypes.DeathReasonAndKiller:
                    GameHistory.overrideDeathReasonAndKiller(TORHelpers.PlayerById(reader.ReadByte()), (DeadPlayer.CustomDeathReason)reader.ReadByte(), TORHelpers.PlayerById(reader.ReadByte()));
                    break;
            }
        }
        ...
        static void Postfix([HarmonyArgument(0)]byte callId, [HarmonyArgument(1)]MessageReader reader)
        {
            ...
            switch (packetId) {
                ...
                case (byte)CustomRPC.EventKick:
                    ...
                    EventUtility.handleKick(TORHelpers.PlayerById(kickSource), TORHelpers.PlayerById(kickTarget), reader.ReadSingle());
                    break;
            }
        }
    }
